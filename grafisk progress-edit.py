...
topframe=Frame(root,)
topframe.pack()
middleframe=Frame(root, width=230,height=300, bg='beige')
...
life. You try to enjoy the time you have
left, but it is increasingly difficult
as the bear efficiently bites every
piece of flesh you have to offer.
...
all systems of defence are about to
shut down, but you struggle against the 
