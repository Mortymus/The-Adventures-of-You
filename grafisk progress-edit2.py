...
topframe=Frame(root,)
topframe.pack()
middleframe=Frame(root, width=230,height=360, bg='beige')
middleframe.propagate(0)
middleframe.pack()
spaceframe1=Frame(root, height=10)
spaceframe1.pack()
bottomframe=Frame(root, bg='beige')
bottomframe.pack()
spaceframe2=Frame(root, height=10)
spaceframe2.pack()
...
line=Label(topframe, text='''--+''', bg='beige')
line.pack(side=LEFT)
headline=Label(topframe, text='''The Amazing Adventures of You''', bg='beige', font=('Times 12 underline'))
headline.pack(side=LEFT)
line2=Label(topframe, text='''+--''', bg='beige')
...
an overwhelming feeling of thirst, only
to find yourself in a beautiful natural
landscape without any idea how you got
there.

You're in the middle of a valley between
tall mountains, with foothills lined with
forests. The floor of the valley is a vast
open space covered with long grass and
shrubbery. It looks like a typical place a
farmer would build fences around to let
sheep graze, but there are no sheep around,
or any other sign of civilization for that
matter.
...
# a branch
a="""
You feel unable to recognise the
importanceof the sudden change of
scenery as a heavy tiredness
overwhelms you. You curl up on the
surprisingly soft ground, and snuggle
into the little nest your body has
formed in the unknown amount of time
it has spent there. Your heavy eyelids
slide down.
...
aa="""
You make no effort to resist the
heavinessof your eyelids, and succumb
to a deepsleep.
	 	
You wake up shortly after as a bear
takes a large bite out of you, just in
time to savour the last seconds of your
life. You try to enjoy the time you
have left, but it becomes increasingly
difficult as the bear efficiently bites
every piece of flesh you have to offer.
...
your eyes to open as much as they can,
you notice a bear approaching.
...
aba="""
You open your mouth and let out a
piercing scream. You're surprised at the
loudness and intensity of the sound
escaping your mouth, especially
considering how seemingly little effort
it took to produce it.

The bear seems to be taken back by the
noise you just made. It pauses, pulling
its face back a bit as it processes the
change of events.
...
abaa="""
You pick up the nearest rock and hurl it
at the bear. It hits the bear in the
middle of the face as he lets out a howl,
prompting it to rise on its hindlegs and
stretching its paws out. It traverses the
distance between the two of you in an
instant, biting into you in a growling
snarl.

You can hear your own flesh gashing
between its teeth as you slowly realise
...
blackbear, a grizzly and a polar bear
walks into a bar... Everybody in there
thought the polar bear was the coolest
one.'

A silence follows the joke as you realise
that bears most likely cant laugh anyway,
and probably haven't had much exposure to
the english language if they could. You
begin reviewing the merits of the thought
process that has led you to this point.
...
'No, i've actually never heard that one
before. And i've heard my share of bear
jokes, many of which quite cruel, being
a bear myself and all.' the bear responds.
...
'Well you know, the polar bear comes
from the arctic, which is a pretty cold
place... and cool also meaning cold, so
the adjective of being cool takes on sort
of a double-meaning, which is for some
reason kind of funny.'

You wonder why you decided to talk about
adjectives to an animal you should be
happy could understand simple english,
let alone the inner workings of its
grammar.
...
ababaaa="""'
Oh, I got the joke.' the bear explains.
'I was just baffled at your decision to
tell it, me being quite decided on eating
you and all.'

An awkward silence follows as you realise
your fear of immediate death was justified.
...
'Actually,' the bear starts. 'I was
planning to eat you as a form of revenge.'
...
overwhelming, and your brave body responds
by letting out loud sobs as it begins shaking.
...
abb="""You halfheartedly clear your throat
before addressing the wild animal in front
of you. 'Oh, hi there Mr. Bear,' you
awkwardly start, before asking how the day
is going so far. The bear sits down, leaning
forward with its paws towards its legs. 'Not
so good,' she answers. 'My cubs are missing.
They were gone when i woke up this morning.'
...
b="""
The backgroud noise slowly rise as you
begin to notice the symphony of animal
life filling the air. The noises of
nature pleasantly fill your head while
you begin to process the impressive,
yet startling, vision before you.
There are wide plains covered with
wild grass and flowers. As your eyes
start focusing on the forest, your
ears begin to single out a constant
sound masked by those of made by birds,
insects and other animals. You realize
its the sound of water trickling
somewhere behind you. That's when you
turn around and see a large bear
approaching you.
...
you. You feel every single tooth he
sinksinto you as he rips your left arm
out. His grip vanishes as your arm is
severed,andyou manage to slowly crawl
away whiletrying to balance your weight
with your one remaining arm.
...
bab="""
You put all the force you can into a
powerful kick to the bears face, firmly
placing your foot in the bear's mouth for
it to chew on. The bear bites into your
thigh and uses his paws to separate your
right leg from the rest of your body.

After what seems like an eternity of
dismemberment, the bear eventually leaves
behind your bloody stump of a leg and
wanders off. You pass out, and linger
between life and death for hours, before
coming to sometime in the afternoon.
...
baba="""
You have a long good cry, wishing you
had someone to hug and tell you
everything will be ok, that your left
arm and right leg will sprout right back,
so you can do crossfit again in no time.
The crying boosts your health levels,
and you feel yourself increasing in power.
...
babaa="""
You start frantically screaming for help,
effectively notifying all the animals in
the forest of your presence. All the
scavengers of the area gather around you
and your bloody mess.

The first animal to take a bite out of
you is actually a bird, soon to be
followed by hundreds of other birds.
The the mice, rats and other vermin set
in, devouring you piece after tiny piece.
It's a slow and painful death.

Game Over."""

babb="""
You drag yourself out from under the rock
using the one arm you have, while helping
with one leg you have. You realise this
is going to be time consuming, and feel a
rising despair at the thought. The despair
fuels a stubborn energy that allows you to
stumble out on your foot, developing a
ridiculus looking walk that resembles a
two-legged elephant. You hear the faint
...
babbb="""
You lay down in the grass, feeling the
warm sun on your face. A feeling of
happiness seem to radiate into you from
the sunlight. Its nice to not have to
continue that stupid quest. You slowly
fall asleep with a wide smile across your
face. When the pack of rats come and gnaw
on your body until there is nothing left,
you look down at your dead body as your
soul drift upwards, hopefully to that
special place you've heard so much about.
...
smeer two streaks under your eyes
before spiking your hair with the
sticky red liquid. You chuckle to
yourself, as you dare any other animals
in this sissy forest to come see what
you're made of. The sound of trickling
water fades back into your perception,
and you still feel parched, even though
you've drank what feels like a couple
of pints of bear blood.
...
bbaaa="""
You feel a surge of adrenaline after
taking what you'd consider a fair sized
bear, and you start chanting in a fasion
you figure would be appropriate, while
slowly beginning to move around the dead
bear in circles. The surprise of waking
up far from civilization stripped of
recent memories has taken a backseat to
how awesomely powerful you feel. As your
voice increases to a higher and more
arrogant pitch, a pack of wolves fly in
from the sideline and rip you to pieces.
...
choice_list=['a','aa','ab','aba','abaa','abab','ababa','ababaa','abb','abba','abbb','b','ba','baa','bab','baba',\
             ...
             'ababaaaba', 'ababaaabb', 'ababaaabba','ababaaabaa','abbbb','abbba','abbbaa','babaa']
scene_list=[a,aa,ab,aba,abaa,abab,ababa,ababaa,abb,abba,abbb,b,ba,baa,bab,baba,babb,babbb,bb,bba,bbaa,bbaaa,bbaab,\
            ...
            babaa]
gameover=['aa','abaa','abba','babbb','bbaaa','ababaaaa','ababaaabaa','abbbb','babaa']
...
Anything can happen here.""", bg='beige').pack()
        buttona.pack_forget()
        buttonb.pack_forget()
        Label(middleframe, text="""
Do you want to try again?
""", bg='beige').pack(side=BOTTOM)
        buttonnew.pack(side=TOP)
    else:
        Label(middleframe, text=scene_list[choice_list.index(choice)], bg='beige').pack()
        if choice in gameover:
            buttona.pack_forget()
            buttonb.pack_forget()
            Label(middleframe, text="""
Do you want to try again?
...
buttona=Button(bottomframe,text='     A     ',bg='lightgreen', activebackground='green', command=choice1)
buttona.pack(side=LEFT)
buttonb=Button(bottomframe, text='     B     ', bg='lightgreen', activebackground='green', command=choice2)
buttonb.pack()
buttonq=Button(quitframe,text='           Quit           ',command=quitting, bg='orange', activebackground='red')
buttonq.pack()
buttonnew=Button(bottomframe, text='     New Game     ', bg='lightgreen', activebackground='green', command=restart)


buttons1 = [buttona,buttonb,buttonq,buttonnew]
